    ...
    <main class="container mx-auto px-4 py-8 space-y-12">
        <section id="supply-chain-overview" class="scroll-mt-24">
            <h3 class="text-2xl font-bold text-slate-800 mb-8 flex items-center gap-2">
                <span class="bg-blue-600 w-2 h-8 rounded-full"></span> 產業鏈結構圖
            </h3>
            
            <div class="bg-white rounded-2xl shadow-xl border border-slate-100 p-6 md:p-8 pb-12 overflow-visible relative">
                <div class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-sky-500 rounded-t-2xl"></div>
                
                <div class="mb-8 text-center">
                    <h2 class="text-xl font-bold text-slate-700 tracking-wide">金融產業鏈簡介</h2>
                    <p class="text-sm text-slate-500 mt-1">涵蓋金控、銀行、保險、證券、期貨與租賃，點擊各板塊查看對應上市機構與職缺情報。</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative mb-12">
                    ...
                    <div class="chain-step relative bg-slate-100/80 p-6 rounded-2xl border border-slate-200 flex flex-col">
                        ...
                        <div class="flex flex-col gap-4 flex-1 justify-between">
                            <button type="button" onclick="showCompanyList('金控業/銀行業/保險業', 'blue')"
                                ...
                                <span class="font-bold text-slate-700 text-sm">金控 / 銀行 / 保險業</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="chain-step relative bg-slate-100/80 p-6 rounded-2xl border border-slate-200 flex flex-col">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold shadow-sm">2</div>
                            <h4 class="text-lg font-bold text-slate-700">證券業</h4>
                        </div>
                        
                        <div class="flex flex-col gap-4 flex-1 justify-between">
                            <button type="button" onclick="showCompanyList('證券業', 'indigo')"
                                ...
                                <span class="font-bold text-slate-700 text-sm">證券投資與經紀</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="chain-step relative bg-slate-100/80 p-6 rounded-2xl border border-slate-200 flex flex-col">
                        ...
                        <div class="flex flex-col gap-4 flex-1 justify-between">
                            <button type="button" onclick="showCompanyList('期貨業', 'purple')"
                                class="bg-white border border-slate-200 hover:border-purple-400 hover:bg-purple-50/50 rounded-xl p-4 transition-all duration-200 flex items-center gap-3 shadow-sm hover:shadow-md text-left group hover:-translate-y-0.5 flex-1">
                                <div class="w-10 h-10 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center text-lg flex-shrink-0 group-hover:scale-105 transition-transform">
                                    <i class="fa-solid fa-scale-balanced"></i>
                                </div>
                                <span class="font-bold text-slate-700 text-sm">期貨與衍生品交易</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="chain-step relative bg-slate-100/80 p-6 rounded-2xl border border-slate-200 flex flex-col">
                        ...
                        <div class="flex flex-col gap-4 flex-1 justify-between">
                            <button type="button" onclick="showCompanyList('租賃業', 'cyan')"
                                ...
                                <span class="font-bold text-slate-700 text-sm">融資租賃與分期</span>
                            </button>
                        </div>
                    </div>
                ...
                <div class="mt-16 space-y-6 relative z-20">
                    <h4 class="text-xl font-bold text-slate-700 pl-4 border-l-4 border-blue-600 flex items-center gap-2">
                        點擊上方區塊查看對應金融機構
                    </h4>
